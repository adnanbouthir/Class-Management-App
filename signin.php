...
<div class="bot">
    ...
    <div class="divmiddle">
        ...
        <ul>
            <li> 
                <a href="#"style="font-weight: 900;">Sign in
                </a>
            </li>
...
<!-- POST SIGN -->
<div class="footsigncontainer">


<div class="footsign">
<div class="stay">   
<input type="checkbox" class="sc" name="sc"checked>Stay Connected
</div>   
...
<div class="or">
  <img src="assets/images/orp.png" alt="">
    </div>
...
<section class="socbut">       
        <p>
            <button  type="button" class="fbbut">Github </button>
        </p>
        <p>
            <button  type="button" class="ggbut">Gmail</button>
        </p>
</section>
</div>
